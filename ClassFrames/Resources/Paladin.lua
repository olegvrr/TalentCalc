...
TCalc_paladinConsecration.resourceCost = "135 mana";
TCalc_paladinConsecration.castCooldown = "Instant cast\t8 sec cooldown";
TCalc_paladinConsecration.requirements = nil;
TCalc_paladinConsecration.talentDescriptions = {};
TCalc_paladinConsecration.talentDescriptions[0] = "Consecrates the land beneath Paladin, doing 64 Holy damage over 8 sec to enemies who enter the area.";
TCalc_paladinConsecration.parentTalent = nil;
...
TCalc_paladinDivineFavor.maxPoints = 1;
TCalc_paladinDivineFavor.talentName = "Divine Favor";
TCalc_paladinDivineFavor.resourceCost = "4% of base mana";
TCalc_paladinDivineFavor.castCooldown = "Instant cast\t2 min cooldown";
...
TCalc_paladinHolyShock.maxPoints = 1;
TCalc_paladinHolyShock.talentName = "Holy Shock";
TCalc_paladinHolyShock.resourceCost = "225 mana\t20 yd range";
TCalc_paladinHolyShock.castCooldown = "Instant cast\t30 sec cooldown";
...
TCalc_paladinBlessingOfKings.maxPoints = 1;
TCalc_paladinBlessingOfKings.talentName = "Blessing of Kings";
TCalc_paladinBlessingOfKings.resourceCost = "8% of base mana\t30 yd range";
TCalc_paladinBlessingOfKings.castCooldown = "Instant cast";
TCalc_paladinBlessingOfKings.requirements = nil;
TCalc_paladinBlessingOfKings.talentDescriptions = {};
TCalc_paladinBlessingOfKings.talentDescriptions[0] = "Places a Blessing on the friendly target, increasing total stats by 10% for 5 min. Players may only have one Blessing on them per Paladin at any one time.";
TCalc_paladinBlessingOfKings.parentTalent = nil;
...
TCalc_paladinBlessingOfSanctuary.maxPoints = 1;
TCalc_paladinBlessingOfSanctuary.talentName = "Blessing of Sanctuary";
TCalc_paladinBlessingOfSanctuary.resourceCost = "60 mana\t30 yd range";
TCalc_paladinBlessingOfSanctuary.castCooldown = "Instant cast";
TCalc_paladinBlessingOfSanctuary.requirements = nil;
...
TCalc_paladinHolyShield.maxPoints = 1;
TCalc_paladinHolyShield.talentName = "Holy Shield";
TCalc_paladinHolyShield.resourceCost = "150 mana";
TCalc_paladinHolyShield.castCooldown = "Instant cast\t10 sec cooldown";
...
TCalc_paladinSealOfCommand.resourceCost = "65 mana";
TCalc_paladinSealOfCommand.castCooldown = "Instant cast";
TCalc_paladinSealOfCommand.requirements = nil;
TCalc_paladinSealOfCommand.talentDescriptions = {};
TCalc_paladinSealOfCommand.talentDescriptions[0] = "Gives the Paladin a chance to deal additional Holy damage equal to 70% of normal weapon damage. Only one Seal can be active on the Paladin at any one time. Lasts 30 sec.\n\nUnleashing this Seal's energy will judge an enemy, instantly causing 46 to 51 Holy damage, 93 to 102 if the target is stunned or incapacitated.";
TCalc_paladinSealOfCommand.parentTalent = nil;
...
TCalc_paladinSanctityAura.resourceCost = nil;
TCalc_paladinSanctityAura.castCooldown = "Instant";
TCalc_paladinSanctityAura.requirements = nil;
TCalc_paladinSanctityAura.talentDescriptions = {};
TCalc_paladinSanctityAura.talentDescriptions[0] = "Increases Holy damage done by party members within 30 yards by 10%. Players may only have one Aura on them per Paladin at any one time.";
TCalc_paladinSanctityAura.parentTalent = nil;
TCalc_paladinSanctityAura.childTalent = nil;
...
TCalc_paladinRepentance.maxPoints = 1;
TCalc_paladinRepentance.talentName = "Repentance";
TCalc_paladinRepentance.resourceCost = "60 mana\t20 yd range";
TCalc_paladinRepentance.castCooldown = "Instant cast\t1 min cooldown";
