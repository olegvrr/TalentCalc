...
TCalc_druidFeralCharge.resourceCost = "50 mana\t25 Yd range";
...
TCalc_druidFaerieFireFeral.resourceCost = nil;
TCalc_druidFaerieFireFeral.castCooldown = nil;
...
TCalc_druidNaturesSwiftness.castCooldown = "Instant cast\t3 in cooldown";
